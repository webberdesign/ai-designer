...
<head>
    ...
    <title>Admin — Business Card Creator</title>
    <!-- Google Font -->
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* Card form and layout styles (mirroring other creators) */
        .page-shell {
            width: 100%;
            max-width: 1200px;
        ...
        .preview-frame.loading::after {
            /* Unified skeleton loader message */
...
<div class="admin-container">
    ...
    <div class="admin-main">
        <?php
            // Determine current script and which pages fall under the Create umbrella for nav highlighting
